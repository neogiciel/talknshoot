...
public class HelpControlChoiseActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_helpcontrolchoise);
		...
		if(camera_selected.equals("HERO6 BLACK")){
			htmlText = (String)this.getString(R.string.helpwifi_control_txt_7);	
		}else if(camera_selected.equals("HERO5 BLACK")){
				htmlText = (String)this.getString(R.string.helpwifi_control_txt_6);	
		}else if(camera_selected.equals("HERO5 SESSION")){
			htmlText = (String)this.getString(R.string.helpwifi_control_txt_5);	
		}else if(camera_selected.equals("HERO SESSION")){
			htmlText = (String)this.getString(R.string.helpwifi_control_txt_4);
		}else if(camera_selected.equals("HERO+")){
			htmlText = (String)this.getString(R.string.helpwifi_control_txt_3);	
		}else if(camera_selected.equals("HERO4")){
			htmlText = (String)this.getString(R.string.helpwifi_control_txt_2);
		}else{
			htmlText = (String)this.getString(R.string.helpwifi_control_txt_1);
		}
	...
	private class ImageGetter implements Html.ImageGetter {
		...
		public Drawable getDrawable(String source) {
		    int id;
		    if (source.equals("camera_list_hero5black.png")) {
